            ...
            <div class="container">
                <div class="banner_content text-center">
                    ...
                    <div class="page_link">
                        ...
                        <a href="news.html">News Health</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="single-post row">
                        <div class="col-lg-12">
                            ...
                            <div class="feature-img">
                                <img class="img-fluid" src="<%=request.getContextPath()%>/template/public/img/blog/<%=objNews.getPicture()%>" alt="">
                            </div>
                            <%} %>
                        </div>
                        ...
                        <div class="col-lg-9 col-md-9 blog_details">
                        	<%
								if(request.getAttribute("objNews") != null){
									News objNews = (News) request.getAttribute("objNews");
							%>
                            <h2><%=objNews.getName()%></h2>
                            <p class="excert">
                                <%=objNews.getPreviewText() %>
                            </p>
                            <p>
                                <%=objNews.getDetailText()%>
                            </p>
                ...
                <div class="col-lg-4">
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <%
								if(request.getAttribute("listTLQ") != null){
									ArrayList<News> listTLQ = (ArrayList<News>) request.getAttribute("listTLQ");
									if(listTLQ.size() > 0){
										for(News objNews : listTLQ){
									
							%>
                                <img style="width:67px; height:41px" src="<%=request.getContextPath()%>/template/public/img/blog/popular-post/<%=objNews.getPicture()%>" alt="post">
                                <div class="media-body">
                                    <a href="<%=request.getContextPath()%>/<%=StringLibrary.createSlug(objNews.getName())%>/public/detail/<%=objNews.getId()%>">
                                        <h3><%=objNews.getName()%></h3>
                                    </a>
                                    <p><%=objNews.getDateCreate()%></p>
                                </div>
                                <%} } } %>
                            </div>
